...
<nav class="flex justify-center small-shadow fixed w-full z-50 bg-white">
    <div class="w-[90%] flex justify-center items-center relative h-[4rem]">
        ...
        <ul class="flex justify-center gap-4 font-rubik-semibold">
            <li><a href="<?=$baseurl . 'tamu-beranda'?>">Beranda</a></li>
            <li><a href="#" class="is-active">Kamar</a></li>
        </ul>
    </div>
</nav>
<main>
        ...
        <form action="<?=$baseurl . 'tamu-reservasi'?>" method="POST" class="w-[80%]">
            ...
            <div class="mb-3 grid grid-cols-2 gap-4">
                <div class="">
                    ...
                    <input class="border-border-gray border-[0.05rem] w-full h-[3rem] p-2 rounded-md" type="date" name="tanggal_checkin" id="">
                </div>
                <div class="">
                    <label for="tanggal_checkout">Tanggal Check Out</label>
                    <input class="border-border-gray border-[0.05rem] w-full h-[3rem] p-2 rounded-md" type="date" name="tanggal_checkout" id="">
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3 flex flex-col items-start cursor-pointer">
                ...
                <div id="dropdown-kamar-btn" class="border-border-gray border-[0.05rem] w-[20%] h-[3rem] ps-2 pe-3 rounded-md flex justify-between items-center">
                    ...
                    <path d="M10.59 -2.67029e-05L6 4.57997L1.41 -2.67029e-05L0 1.40997L6 7.40997L12 1.40997L10.59 -2.67029e-05Z" fill="black"/>
                    </svg>
                </div>
                <ul id="dropdown-kamar" class="border-border-gray hidden border-x-[0.05rem] border-b-[0.05rem] w-[20%] max-h-[8rem] overflow-y-scroll rounded-md rounded-t-none justify-between flex-col items-center">
                    <?php 
                    $count = count($kamars);
